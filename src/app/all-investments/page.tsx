...
import TransactionSearch, { FilterOption, SortOption } from "../components/dashboard/wallet/transactionSearch";
import TransactionFilterMobile from "../components/dashboard/wallet/mobileTransactionSearch";
import TransactionCard from "../components/dashboard/wallet/TransactionCard";
...
export default function AllInvestments() {  // use dummy data only
  ...
  return (
    <InvestorLayout>
      <main className="px-10 lg:px-4 py-10 overflow-auto h-full bg-gray-50">
        <section className="">
          <GoBackBtn href="/investor-dashboard/wallet" />
          <div className="bg-white mt-4 rounded-lg border border-[#E3E3E5]">
            <div>
            <TransactionSearch
