  ...
  return (
    <section className="">
      <div className="grid grid-cols-[2fr_1fr] gap-x-8">
        <div className="bg-[#226646] border border-[#51F4A6] flex items-center gap-6 rounded-xl p-4">
          <Image
            src="/assets/store-front/avat.png"
            width={225}
            height={178}
            alt="avatar"
          />
          ...
          <div>
            ...
            <p className=" font-poppinsRegular mb-4 text-[white]">
              Aderibigbe Adigun, a pioneer in sustainable farming practices.
            </p>
