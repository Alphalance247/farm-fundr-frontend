...
const PaymentStep: React.FC<PaymentStepProps> = ({
  ...
  return (
    <>
      <div className="flex-1 w-full xl:max-w-xl lg:max-w-full mx-auto">
        ...
        <div className="bg-white shadow rounded-lg p-6 md:p-3">
          ...
          <div className="mb-8 border-t border-[#F2F2F3] pt-2">
            ...
            <div className="space-y-3 border-t border-[#F2F2F3] pt-2">
              <div className="flex flex-row md:flex-col md:gap-4 md:items-start border-b border-[#F2F2F3] pb-2 justify-between items-center py-2">
              ...
              <div className="flex border-b flex-row md:flex-col md:gap-4 md:items-start border-[#F2F2F3] pb-2 justify-between items-center py-2">
                <p className="text-sm text-[#5F5F5F] font-poppinsRegular">
                  Date
                </p>
                <p className="text-sm text-[#5F5F5F] font-poppinsSemiBold">
