          ...
          <div>
            <div className="space-y-4">
              <FileUpload
                ...
                onFileChange={(file) => onFormDataChange({ ...formData, idDocument: file })}
              ...
              <FileUpload
                ...
                onFileChange={(file) => onFormDataChange({ ...formData, passportPhoto: file })}
              ...
              <FileUpload
                ...
                maxSize={5 * 1024 * 1024} 
                maxSizeText="5mb size, pdf, jpeg, png format only"
                onFileChange={(file) => onFormDataChange({ ...formData, signature: file })}
