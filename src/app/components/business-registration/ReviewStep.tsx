...
const ReviewStep: React.FC<ReviewStepProps> = ({
  ...
  useEffect(() => {
    ...
    const storedProprietorData = localStorage.getItem(
  ...
  return (
    <div className="flex-1 max-w-lg lg:max-w-full mx-auto">
      <div className="text-center block lg:hidden mb-8">
        ...
        <h1 className="text-3xl font-aristoBold text-[#303030] mb-2">Review</h1>
      ...
      <div className="bg-white shadow rounded-lg p-6 md:p-3">
        <div className="mb-8">
          <div className="flex items-center justify-center lg:justify-between gap-4 mb-6">
          ...
          <div className="space-y-4">
            <div className="flex flex-row md:items-start md:flex-col md:gap-4 justify-between items-center py-3 border-b border-[#F0F0F0]">
            ...
            <div className="flex md:items-start justify-between flex-row md:flex-col md:gap-4 items-center py-3 border-b border-[#F0F0F0]">
              <p className="text-sm text-[#5F5F5F] font-poppinsRegular">
                Propose Name 2
              </p>
              <p className="text-sm text-[#5F5F5F] font-poppinsSemiBold">
            ...
            <div className="flex justify-between md:items-start flex-row md:flex-col md:gap-4 items-center py-3 border-b border-[#F0F0F0]">
              <p className="text-sm text-[#5F5F5F] font-poppinsRegular">
                Email Address
              </p>
              <p className="text-sm text-[#5F5F5F] font-poppinsSemiBold">
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex flex-row md:items-start md:flex-col md:gap-4 justify-between items-center py-3 border-b border-[#F0F0F0]">
              <p className="text-sm text-[#5F5F5F] font-poppinsRegular">Name</p>
              <p className="text-sm text-[#5F5F5F] font-poppinsSemiBold">
            ...
            <div className="grid grid-cols-2 xl:grid-cols-1 gap-10">
              <div className="py-3">
                ...
                <div className="w-32 h-32 xl:w-full xl:h-full border border-[#E2E2E2] rounded-lg overflow-hidden">
                  <Image
                    width={128}
                    height={128}
