...
export default function WalletCard() {
  ...
  const handleViewTransactions = () => {
    ...
    return (
      <>
    <section className="mt-6 px-6 w-[40%] lg:w-full py-8 border border-gray-200 bg-white rounded-2xl space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#2D865B] to-[#12482F] border-[#C9FCE3] border text-white rounded-xl p-4 ">
      ...
      <div className="bg-gradient-to-r from-[#C9FCE3] to-[#8BBEA5] border border-[#51F4A6] text-[#34474E] rounded-xl p-4">
        <div className="space-y-2">
