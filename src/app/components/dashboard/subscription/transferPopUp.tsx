...
const TransferPopUP: React.FC<{ onClick: () => void }> = ({ onClick }) => {
  ...
  return (
    <div className="px-6 py-10 bg-white shadow-lg w-[500px] rounded-xl mx-auto absolute z-20 top-[8rem] left-[34rem]">
      <div className=" border-b border-b-[#E2E2E2] flex justify-between pb-3">
        <p className="text-2xl font-aristoBold text-[#5F5F5F]">Make Transfer</p>
