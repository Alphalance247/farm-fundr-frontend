...
const AgencySubscriptionPlans = () => {
  ...
  useEffect(() => {
    ...
    if (storedUserType) {
      ...
      router.push("/agency-dashboard/subscription");
    }
  }, []);
  ...
  const plantoChoose = selectedPlan === "1" ? data : standardPlan;

  return (
    <AgencyLayout>
      {plantoChoose.map((item, i) => (
        <BillingFrequency
          heading="Billing frequency"
          planName="Basic Plan"
...
export default AgencySubscriptionPlans;
